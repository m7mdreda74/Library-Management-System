    ...
    <div class="py-12 lg:py-16">
        <div class="w-full mx-auto sm:px-6 lg:px-12">
            <div class="p-6 sm:p-10 lg:p-12 bg-white shadow sm:rounded-lg">
                ...
                <!-- Back Button -->
                <a href="/home" class="btn btn-primary mb-6">
                    Back
                </a>

                <!-- Student Count -->
                <div class="mb-6">
                    <h3 class="text-lg font-bold">Total Students: {{ $countUsers }}</h3>
                </div>

                <!-- Search Section -->
                <div class="mb-6">
                    <h3 class="text-center mb-4">Search for a Student</h3>
                    <form action="{{ route('search.student') }}" method="post" class="d-flex justify-content-center align-items-center">
                        @csrf
                        <input type="text" name="student_id" placeholder="Enter Student ID" class="border rounded p-2 mr-2" aria-label="Student ID">
